...
class MyCIFAR10(CIFAR10):
    ...
    def __getitem__(self, index: int) -> Tuple[type(Image), int, type(Image)]:
        ...
        return img, img, target, not_aug_img


class SequentialCIFAR10P(ContinualDataset):
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), SequentialCIFAR10P.TRANSFORM])
        return transform

    @staticmethod
    def get_backbone():
        return resnet18(SequentialCIFAR10P.N_CLASSES_PER_TASK
                        * SequentialCIFAR10P.N_TASKS)
