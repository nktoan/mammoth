...
class SequentialCore50P(ContinualDataset):
    ...
    TRANSFORM = transforms.Compose(
            [
                ...
                transforms.RandomApply([color_jitter], p = 0.25),
    ...
    @staticmethod
    def get_backbone():
        return resnet18(np.sum(SequentialCore50P.N_CLASSES_PER_TASK))
    ...
    def get_normalization_transform():
        transform = transforms.Normalize(SequentialCore50P._mean,
                                         SequentialCore50P._std)
        return transform

    @staticmethod
    def get_denormalization_transform():
        transform = DeNormalize(SequentialCore50P._mean,
                                         SequentialCore50P._std)
        return transform