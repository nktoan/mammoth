...
class SequentialCIFAR100_20P(ContinualDataset):

    NAME = 'seq-cifar100-20p'
    SETTING = 'class-il'
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), SequentialCIFAR100_20P.TRANSFORM])
        return transform

    @staticmethod
    def get_backbone():
        return resnet18(SequentialCIFAR100_20P.N_CLASSES_PER_TASK
                       * SequentialCIFAR100_20P.N_TASKS)
