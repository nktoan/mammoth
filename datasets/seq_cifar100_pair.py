...
class SequentialCIFAR100P(ContinualDataset):
    ...
    def get_transform():
        transform = transforms.Compose(
            [transforms.ToPILImage(), SequentialCIFAR100P.TRANSFORM])
        return transform

    @staticmethod
    def get_backbone():
        return resnet18(SequentialCIFAR100P.N_CLASSES_PER_TASK
                       * SequentialCIFAR100P.N_TASKS)
